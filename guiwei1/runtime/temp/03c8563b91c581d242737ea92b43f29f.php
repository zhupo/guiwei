<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:96:"/Users/panliu/Documents/privateProject/guiwei/guiwei1/addons/cms/view/default1/list_product.html";i:1688779705;s:94:"/Users/panliu/Documents/privateProject/guiwei/guiwei1/addons/cms/view/default1/common/top.html";i:1688916874;s:94:"/Users/panliu/Documents/privateProject/guiwei/guiwei1/addons/cms/view/default1/common/mbx.html";i:1688779705;s:95:"/Users/panliu/Documents/privateProject/guiwei/guiwei1/addons/cms/view/default1/common/left.html";i:1688779705;s:95:"/Users/panliu/Documents/privateProject/guiwei/guiwei1/addons/cms/view/default1/common/foot.html";i:1688779705;}*/ ?>
<!doctype html>
<html>
 <head> 
 ...
 <body> 
  <div class="container"> 
   ...
   <header class="web_head index_web_head"> 
    ...
    <div class="head_layout layout"> 
     ...
     <nav class="nav_wrap"> 
      <ul class="head_nav"> 
       <?php $__5wLO3TymEg__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","type"=>"top","cache"=>"0","condition"=>"1=isnav","row"=>"20","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__5wLO3TymEg__) || $__5wLO3TymEg__ instanceof \think\Collection || $__5wLO3TymEg__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__5wLO3TymEg__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
        <li>
            <a href="<?php echo $nav['url']; ?>"><?php echo $nav['name']; ?></a>
            <?php if($nav['has_child']): ?>
                <ul>
                    <?php $__hytLSu7KqA__ = \addons\cms\model\Channel::getChannelList(["id"=>"son","type"=>"son","condition"=>"1=isnav","typeid"=>$nav['id'],"cache"=>"0","row"=>"20"]); if(is_array($__hytLSu7KqA__) || $__hytLSu7KqA__ instanceof \think\Collection || $__hytLSu7KqA__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__hytLSu7KqA__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$son): $mod = ($i % 2 );++$i;?>
                        <li><a href="<?php echo $son['url']; ?>"><?php echo $son['name']; ?></a>
                        <?php if($son['has_child']): ?>
                            <ul>
                            <?php $__KEtOz1hQ4J__ = \addons\cms\model\Channel::getChannelList(["id"=>"sons","condition"=>"1=isnav","type"=>"son","typeid"=>$son['id'],"cache"=>"0"]); if(is_array($__KEtOz1hQ4J__) || $__KEtOz1hQ4J__ instanceof \think\Collection || $__KEtOz1hQ4J__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__KEtOz1hQ4J__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sons): $mod = ($i % 2 );++$i;?>
                                <li><a href="<?php echo $sons['url']; ?>"><?php echo $sons['name']; ?></a></li>
                            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__KEtOz1hQ4J__; ?>
                            </ul> 
                        <?php endif; ?>
                        </li>
                    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__hytLSu7KqA__; ?>
                </ul>
            <?php endif; ?>
        </li>
        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__5wLO3TymEg__; ?>
      </ul> 
      <!--change-language--> 
  ...
  <ul class="prisna-wp-translate-seo" id="prisna-translator-seo"> 
   ...
   <section class="path_bar"> 
    <ul> 
     <!-- <li>Products</li>  -->
     <?php $__BAOk6fyhct__ = \addons\cms\model\Channel::getBreadcrumb($__CHANNEL__??[], $__ARCHIVES__??[], $__TAGS__??[], $__PAGE__??[], $__DIYFORM__??[]); if(is_array($__BAOk6fyhct__) || $__BAOk6fyhct__ instanceof \think\Collection || $__BAOk6fyhct__ instanceof \think\Paginator): $k = 0; $__LIST__ = $__BAOk6fyhct__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($k % 2 );++$k;?>
     <li class="nav_current"><a title="<?php echo $item['name']; ?>" href="<?php echo $item['url']; ?>"><?php echo $item['name']; ?></a></li> 
     <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__BAOk6fyhct__; ?>
    </ul> 
   </section>  
   <!-- page-layout start --> 
   <section class="web_main page_main"> 
    ...
    <div class="aside-wrap"> 
     <div class="side-widget"> 
      ...
      <ul class="side-cate"> 
        <?php $__8EbeWI2vaA__ = \addons\cms\model\Channel::getChannelList(["id"=>"channel","type"=>"son","typeid"=>"44","row"=>"100"]); if(is_array($__8EbeWI2vaA__) || $__8EbeWI2vaA__ instanceof \think\Collection || $__8EbeWI2vaA__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__8EbeWI2vaA__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;?>
            <li class="<?php if($channel['is_active']): ?>nav-current<?php endif; ?>"><a href="<?php echo $channel['url']; ?>"><?php echo $channel['name']; ?></a> 
                ...
                <ul class="sub-menu"> 
                    <?php $__w1PLabqxFs__ = \addons\cms\model\Channel::getChannelList(["id"=>"sonChannel","type"=>"son","typeid"=>$channel['id'],"row"=>"100"]); if(is_array($__w1PLabqxFs__) || $__w1PLabqxFs__ instanceof \think\Collection || $__w1PLabqxFs__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__w1PLabqxFs__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sonChannel): $mod = ($i % 2 );++$i;?>
                        <li class="<?php if($sonChannel['is_active']): ?>nav-current<?php endif; ?>"><a href="<?php echo $sonChannel['url']; ?>"><?php echo $sonChannel['name']; ?></a></li> 
                    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__w1PLabqxFs__; ?>
                </ul> 
                <?php endif; ?>
            </li> 
       <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__8EbeWI2vaA__; ?>
      </ul> 
     </div> 
     <div class="side-widget"> 
      <div class="side-tit-bar"> 
       ...
       <div class="items_content"> 
        <div class="side_slider"> 
         <ul class="swiper-wrapper"> 
            <?php $__MQTrZs5kD1__ = \addons\cms\model\Channel::getChannelList(["id"=>"channel","type"=>"son","typeid"=>"44","orderby"=>"weigh","orderway"=>"asc"]); if(is_array($__MQTrZs5kD1__) || $__MQTrZs5kD1__ instanceof \think\Collection || $__MQTrZs5kD1__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__MQTrZs5kD1__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;$__pWx8EuVmqi__ = \addons\cms\model\Archives::getArchivesList(["id"=>"prod","channel"=>$channel['id'],"orderby"=>"weigh","orderway"=>"desc","row"=>"20"]); if(is_array($__pWx8EuVmqi__) || $__pWx8EuVmqi__ instanceof \think\Collection || $__pWx8EuVmqi__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__pWx8EuVmqi__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$prod): $mod = ($i % 2 );++$i;?>
            ...
            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__pWx8EuVmqi__; endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__MQTrZs5kD1__; ?>
         </ul> 
        </div> 
     ...
     <section class="main"> 
      <div class="product-list"> 
       <ul class="product_list_items"> 
        <?php $__Hy7Ft1Num6__ = $__PAGELIST__; if(is_array($__Hy7Ft1Num6__) || $__Hy7Ft1Num6__ instanceof \think\Collection || $__Hy7Ft1Num6__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__Hy7Ft1Num6__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
		...
		<?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__Hy7Ft1Num6__; ?>
       </ul> 
       <div class="page_bar"> 
        <!-- <div class="pages"> -->
   ...
   <footer class="web_footer"> 
    <ul class="foot_nav wow fadeInUpA" data-wow-delay="1s" data-wow-duration=".8s"> 
     <?php $__7NfzYE2ATo__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","type"=>"top","cache"=>"0","condition"=>"1=isnav","row"=>"20","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__7NfzYE2ATo__) || $__7NfzYE2ATo__ instanceof \think\Collection || $__7NfzYE2ATo__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__7NfzYE2ATo__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
        <li><a href="<?php echo $nav['url']; ?>"><?php echo $nav['name']; ?></a> </li>
     <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__7NfzYE2ATo__; ?>
    </ul> 
    <div class="foot_bottom layout"> 
     ...
     <ul class="foot_sns wow fadeInUpA" data-wow-delay="1.5s" data-wow-duration=".8s"> 
        <?php $__2zIVyHLZbM__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"media","orderby"=>"weigh","orderway"=>"asc"]); if(is_array($__2zIVyHLZbM__) || $__2zIVyHLZbM__ instanceof \think\Collection || $__2zIVyHLZbM__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__2zIVyHLZbM__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
            <li><a href="<?php echo $block['url']; ?>"><img src="<?php echo $block['image']; ?>" alt="<?php echo $block['title']; ?>"></a></li> 
        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__2zIVyHLZbM__; ?>
     </ul> 
  ...
  <aside class="scrollsidebar" id="scrollsidebar"> 
   <section class="side_content"> 
    <div class="side_list"> 
     ...
     <div class="t-code">
    <?php $__P0iKwnWofp__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"online-service","orderby"=>"weigh","orderway"=>"asc"]); if(is_array($__P0iKwnWofp__) || $__P0iKwnWofp__ instanceof \think\Collection || $__P0iKwnWofp__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__P0iKwnWofp__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
      <img src="<?php echo $block['image']; ?>">
    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__P0iKwnWofp__; ?>
