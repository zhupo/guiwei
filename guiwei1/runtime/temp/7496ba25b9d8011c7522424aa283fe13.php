  ...
  <div class="container"> 
   ...
   <header class="web_head index_web_head"> 
    ...
    <div class="head_layout layout"> 
     ...
     <nav class="nav_wrap"> 
      <ul class="head_nav"> 
       <?php $__zLm4TPrGoy__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","type"=>"top","cache"=>"0","condition"=>"1=isnav","row"=>"20","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__zLm4TPrGoy__) || $__zLm4TPrGoy__ instanceof \think\Collection || $__zLm4TPrGoy__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__zLm4TPrGoy__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
        <li>
            <a href="<?php echo $nav['url']; ?>"><?php echo $nav['name']; ?></a>
            <?php if($nav['has_child']): ?>
                <ul>
                    <?php $__7yhNIzk0uS__ = \addons\cms\model\Channel::getChannelList(["id"=>"son","type"=>"son","condition"=>"1=isnav","typeid"=>$nav['id'],"cache"=>"0","row"=>"20"]); if(is_array($__7yhNIzk0uS__) || $__7yhNIzk0uS__ instanceof \think\Collection || $__7yhNIzk0uS__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__7yhNIzk0uS__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$son): $mod = ($i % 2 );++$i;?>
                        <li><a href="<?php echo $son['url']; ?>"><?php echo $son['name']; ?></a>
                        <?php if($son['has_child']): ?>
                            <ul>
                            <?php $__u4PXNtQEwa__ = \addons\cms\model\Channel::getChannelList(["id"=>"sons","condition"=>"1=isnav","type"=>"son","typeid"=>$son['id'],"cache"=>"0"]); if(is_array($__u4PXNtQEwa__) || $__u4PXNtQEwa__ instanceof \think\Collection || $__u4PXNtQEwa__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__u4PXNtQEwa__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sons): $mod = ($i % 2 );++$i;?>
                                <li><a href="<?php echo $sons['url']; ?>"><?php echo $sons['name']; ?></a></li>
                            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__u4PXNtQEwa__; ?>
                            </ul> 
                        <?php endif; ?>
                        </li>
                    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__7yhNIzk0uS__; ?>
                </ul>
            <?php endif; ?>
        </li>
        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__zLm4TPrGoy__; ?>
      </ul> 
      <!--change-language--> 
...
<div class="about">
    <div class="wp cl">
      <div class="pic">
        <?php $__56Hosanxbk__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"ourHistory","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__56Hosanxbk__) || $__56Hosanxbk__ instanceof \think\Collection || $__56Hosanxbk__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__56Hosanxbk__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?> 
        ...
        <div class="txt"><h3><?php echo $block['title']; ?></h3><p><em></em></p>
          ...
          <p><br></p>
               ...
               <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__56Hosanxbk__; ?>
        
    </div>
  </div>
  <div class="about2">
    <div class="wp cl">
      <?php $__ckCXuAKHL7__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"factory","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__ckCXuAKHL7__) || $__ckCXuAKHL7__ instanceof \think\Collection || $__ckCXuAKHL7__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__ckCXuAKHL7__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?> 
      <div class="tit">
      ...
      <?php endif; endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__ckCXuAKHL7__; ?> 
    </div>
  </div>
  <div class="about3">
      <?php $__FTJQAMBD96__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"production","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__FTJQAMBD96__) || $__FTJQAMBD96__ instanceof \think\Collection || $__FTJQAMBD96__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__FTJQAMBD96__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?> 
      <h3><?php echo $block['title']; ?></h3>
      <hr/>
         <?php if(!(empty($block['images']) || (($block['images'] instanceof \think\Collection || $block['images'] instanceof \think\Paginator ) && $block['images']->isEmpty()))): ?>
         <ul>
      ...
      <?php endif; endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__FTJQAMBD96__; ?> 
  </div>
  <div class="about4"> 
    <?php $__XaW9pDt3Hb__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"ourCurrent","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__XaW9pDt3Hb__) || $__XaW9pDt3Hb__ instanceof \think\Collection || $__XaW9pDt3Hb__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__XaW9pDt3Hb__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?> 
    <h3><?php echo $block['title']; ?></h3>
    <?php echo $block['content']; ?>
    <div class="pic"> <img src="<?php echo $block['image']; ?>" alt="<?php echo $block['title']; ?>"/> </div>
    {/tmp:ad} 
    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__XaW9pDt3Hb__; ?>
  </div>

<footer class="web_footer"> 
    <ul class="foot_nav wow fadeInUpA" data-wow-delay="1s" data-wow-duration=".8s"> 
     <?php $__9U4P6lv75O__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","type"=>"top","cache"=>"0","condition"=>"1=isnav","row"=>"20","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__9U4P6lv75O__) || $__9U4P6lv75O__ instanceof \think\Collection || $__9U4P6lv75O__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__9U4P6lv75O__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
        <li><a href="<?php echo $nav['url']; ?>"><?php echo $nav['name']; ?></a> </li>
     <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__9U4P6lv75O__; ?>
    </ul> 
    <div class="foot_bottom layout"> 
     ...
     <ul class="foot_sns wow fadeInUpA" data-wow-delay="1.5s" data-wow-duration=".8s"> 
        <?php $__ZkiLIH9RmD__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"media","orderby"=>"weigh","orderway"=>"asc"]); if(is_array($__ZkiLIH9RmD__) || $__ZkiLIH9RmD__ instanceof \think\Collection || $__ZkiLIH9RmD__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__ZkiLIH9RmD__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
            <li><a href="<?php echo $block['url']; ?>"><img src="<?php echo $block['image']; ?>" alt="<?php echo $block['title']; ?>"></a></li> 
        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__ZkiLIH9RmD__; ?>
     </ul> 
  ...
  <aside class="scrollsidebar" id="scrollsidebar"> 
   <section class="side_content"> 
    <div class="side_list"> 
     ...
     <div class="t-code">
    <?php $__fu4ic9OB5I__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"online-service","orderby"=>"weigh","orderway"=>"asc"]); if(is_array($__fu4ic9OB5I__) || $__fu4ic9OB5I__ instanceof \think\Collection || $__fu4ic9OB5I__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__fu4ic9OB5I__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
      <img src="<?php echo $block['image']; ?>">
    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__fu4ic9OB5I__; ?>
