<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:93:"/Users/panliu/Documents/privateProject/guiwei/guiwei1/addons/cms/view/default1/list_News.html";i:1688914626;s:94:"/Users/panliu/Documents/privateProject/guiwei/guiwei1/addons/cms/view/default1/common/top.html";i:1688916874;s:94:"/Users/panliu/Documents/privateProject/guiwei/guiwei1/addons/cms/view/default1/common/mbx.html";i:1688779705;s:99:"/Users/panliu/Documents/privateProject/guiwei/guiwei1/addons/cms/view/default1/common/new_left.html";i:1688914671;s:95:"/Users/panliu/Documents/privateProject/guiwei/guiwei1/addons/cms/view/default1/common/foot.html";i:1688779705;}*/ ?>
<!doctype html>
<html>
 <head> 
 ...
 <body> 
  <div class="container"> 
   ...
   <header class="web_head index_web_head"> 
    ...
    <div class="head_layout layout"> 
     ...
     <nav class="nav_wrap"> 
      <ul class="head_nav"> 
       <?php $__YPOBeMqhSs__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","type"=>"top","cache"=>"0","condition"=>"1=isnav","row"=>"20","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__YPOBeMqhSs__) || $__YPOBeMqhSs__ instanceof \think\Collection || $__YPOBeMqhSs__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__YPOBeMqhSs__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
        <li>
            <a href="<?php echo $nav['url']; ?>"><?php echo $nav['name']; ?></a>
            <?php if($nav['has_child']): ?>
                <ul>
                    <?php $__iht7cuaKV6__ = \addons\cms\model\Channel::getChannelList(["id"=>"son","type"=>"son","condition"=>"1=isnav","typeid"=>$nav['id'],"cache"=>"0","row"=>"20"]); if(is_array($__iht7cuaKV6__) || $__iht7cuaKV6__ instanceof \think\Collection || $__iht7cuaKV6__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__iht7cuaKV6__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$son): $mod = ($i % 2 );++$i;?>
                        <li><a href="<?php echo $son['url']; ?>"><?php echo $son['name']; ?></a>
                        <?php if($son['has_child']): ?>
                            <ul>
                            <?php $__SAlqC6XPdr__ = \addons\cms\model\Channel::getChannelList(["id"=>"sons","condition"=>"1=isnav","type"=>"son","typeid"=>$son['id'],"cache"=>"0"]); if(is_array($__SAlqC6XPdr__) || $__SAlqC6XPdr__ instanceof \think\Collection || $__SAlqC6XPdr__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__SAlqC6XPdr__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sons): $mod = ($i % 2 );++$i;?>
                                <li><a href="<?php echo $sons['url']; ?>"><?php echo $sons['name']; ?></a></li>
                            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__SAlqC6XPdr__; ?>
                            </ul> 
                        <?php endif; ?>
                        </li>
                    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__iht7cuaKV6__; ?>
                </ul>
            <?php endif; ?>
        </li>
        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__YPOBeMqhSs__; ?>
      </ul> 
      <!--change-language--> 
  ...
  <ul class="prisna-wp-translate-seo" id="prisna-translator-seo"> 
   ...
   <section class="path_bar"> 
    <ul> 
     <!-- <li>Products</li>  -->
     <?php $__IVRZUahkP4__ = \addons\cms\model\Channel::getBreadcrumb($__CHANNEL__??[], $__ARCHIVES__??[], $__TAGS__??[], $__PAGE__??[], $__DIYFORM__??[]); if(is_array($__IVRZUahkP4__) || $__IVRZUahkP4__ instanceof \think\Collection || $__IVRZUahkP4__ instanceof \think\Paginator): $k = 0; $__LIST__ = $__IVRZUahkP4__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($k % 2 );++$k;?>
     <li class="nav_current"><a title="<?php echo $item['name']; ?>" href="<?php echo $item['url']; ?>"><?php echo $item['name']; ?></a></li> 
     <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__IVRZUahkP4__; ?>
    </ul> 
   </section>  
   <!-- page-layout start --> 
  ...
  <div class="aside-wrap"> 
   <div class="side-widget"> 
    ...
    <ul class="side-cate"> 
      <?php $__catVQ0KdTP__ = \addons\cms\model\Channel::getChannelList(["id"=>"channel","type"=>"son","typeid"=>"66","row"=>"100"]); if(is_array($__catVQ0KdTP__) || $__catVQ0KdTP__ instanceof \think\Collection || $__catVQ0KdTP__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__catVQ0KdTP__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;?>
          <li class="<?php if($channel['is_active']): ?>nav-current<?php endif; ?>"><a href="<?php echo $channel['url']; ?>"><?php echo $channel['name']; ?></a> 
              ...
              <ul class="sub-menu"> 
                  <?php $__ntcTUHGeig__ = \addons\cms\model\Channel::getChannelList(["id"=>"sonChannel","type"=>"son","typeid"=>$channel['id'],"row"=>"100"]); if(is_array($__ntcTUHGeig__) || $__ntcTUHGeig__ instanceof \think\Collection || $__ntcTUHGeig__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__ntcTUHGeig__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sonChannel): $mod = ($i % 2 );++$i;?>
                      <li class="<?php if($sonChannel['is_active']): ?>nav-current<?php endif; ?>"><a href="<?php echo $sonChannel['url']; ?>"><?php echo $sonChannel['name']; ?></a></li> 
                  <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__ntcTUHGeig__; ?>
              </ul> 
              <?php endif; ?>
          </li> 
     <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__catVQ0KdTP__; ?>
    </ul> 
   </div> 
  </div> 
 </aside>  
     ...
     <section class="main"> 
      <div class="product-list"> 
       <ul class="product_list_items"> 
        <?php $__oIL3dWglK9__ = $__PAGELIST__; if(is_array($__oIL3dWglK9__) || $__oIL3dWglK9__ instanceof \think\Collection || $__oIL3dWglK9__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__oIL3dWglK9__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
		...
		<?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__oIL3dWglK9__; ?>
       </ul> 
       <div class="page_bar"> 
        <!-- <div class="pages"> -->
   ...
   <footer class="web_footer"> 
    <ul class="foot_nav wow fadeInUpA" data-wow-delay="1s" data-wow-duration=".8s"> 
     <?php $__VRzBDt40Yq__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","type"=>"top","cache"=>"0","condition"=>"1=isnav","row"=>"20","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__VRzBDt40Yq__) || $__VRzBDt40Yq__ instanceof \think\Collection || $__VRzBDt40Yq__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__VRzBDt40Yq__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
        <li><a href="<?php echo $nav['url']; ?>"><?php echo $nav['name']; ?></a> </li>
     <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__VRzBDt40Yq__; ?>
    </ul> 
    <div class="foot_bottom layout"> 
     ...
     <ul class="foot_sns wow fadeInUpA" data-wow-delay="1.5s" data-wow-duration=".8s"> 
        <?php $__9ufyLQcm5b__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"media","orderby"=>"weigh","orderway"=>"asc"]); if(is_array($__9ufyLQcm5b__) || $__9ufyLQcm5b__ instanceof \think\Collection || $__9ufyLQcm5b__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__9ufyLQcm5b__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
            <li><a href="<?php echo $block['url']; ?>"><img src="<?php echo $block['image']; ?>" alt="<?php echo $block['title']; ?>"></a></li> 
        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__9ufyLQcm5b__; ?>
     </ul> 
  ...
  <aside class="scrollsidebar" id="scrollsidebar"> 
   <section class="side_content"> 
    <div class="side_list"> 
     ...
     <div class="t-code">
    <?php $__CWQUL146h3__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"online-service","orderby"=>"weigh","orderway"=>"asc"]); if(is_array($__CWQUL146h3__) || $__CWQUL146h3__ instanceof \think\Collection || $__CWQUL146h3__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__CWQUL146h3__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
      <img src="<?php echo $block['image']; ?>">
    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__CWQUL146h3__; ?>
