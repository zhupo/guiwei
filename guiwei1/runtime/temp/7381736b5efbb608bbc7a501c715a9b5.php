 ...
 <body> 
  <div class="container"> 
   ...
   <header class="web_head index_web_head"> 
    ...
    <div class="head_layout layout"> 
     ...
     <nav class="nav_wrap"> 
      <ul class="head_nav"> 
       <?php $__f04TEi5pJz__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","type"=>"top","cache"=>"0","condition"=>"1=isnav","row"=>"20","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__f04TEi5pJz__) || $__f04TEi5pJz__ instanceof \think\Collection || $__f04TEi5pJz__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__f04TEi5pJz__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
        <li>
            <a href="<?php echo $nav['url']; ?>"><?php echo $nav['name']; ?></a>
            <?php if($nav['has_child']): ?>
                <ul>
                    <?php $__3qCTvQDmOh__ = \addons\cms\model\Channel::getChannelList(["id"=>"son","type"=>"son","condition"=>"1=isnav","typeid"=>$nav['id'],"cache"=>"0","row"=>"20"]); if(is_array($__3qCTvQDmOh__) || $__3qCTvQDmOh__ instanceof \think\Collection || $__3qCTvQDmOh__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__3qCTvQDmOh__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$son): $mod = ($i % 2 );++$i;?>
                        <li><a href="<?php echo $son['url']; ?>"><?php echo $son['name']; ?></a>
                        <?php if($son['has_child']): ?>
                            <ul>
                            <?php $__Sh8Tv13JEz__ = \addons\cms\model\Channel::getChannelList(["id"=>"sons","condition"=>"1=isnav","type"=>"son","typeid"=>$son['id'],"cache"=>"0"]); if(is_array($__Sh8Tv13JEz__) || $__Sh8Tv13JEz__ instanceof \think\Collection || $__Sh8Tv13JEz__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__Sh8Tv13JEz__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sons): $mod = ($i % 2 );++$i;?>
                                <li><a href="<?php echo $sons['url']; ?>"><?php echo $sons['name']; ?></a></li>
                            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__Sh8Tv13JEz__; ?>
                            </ul> 
                        <?php endif; ?>
                        </li>
                    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__3qCTvQDmOh__; ?>
                </ul>
            <?php endif; ?>
        </li>
        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__f04TEi5pJz__; ?>
      </ul> 
      <!--change-language--> 
  ...
  <ul class="prisna-wp-translate-seo" id="prisna-translator-seo"> 
   ...
   <section class="slider_banner swiper-container"> 
    ...
    <?php $__PBrsZOFGDa__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"banner","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__PBrsZOFGDa__) || $__PBrsZOFGDa__ instanceof \think\Collection || $__PBrsZOFGDa__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__PBrsZOFGDa__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>   
      <div class="swiper-slide">
        <a href="<?php echo $block['url']; ?>"><img src="<?php echo $block['image']; ?>" alt=""></a>
      </div> 
    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__PBrsZOFGDa__; ?>
    </div> 
   ...
   <section class="web_main index_main"> 
     ...
     <section class="layout"> 
      ...
      <section class="feature_item_wrap wow fadeInUpA" data-wow-delay="1.3s" data-wow-duration=".8s"> 
       <div class="feature_items"> 
        ...
        <?php $__pkXKO7vjih__ = \addons\cms\model\Channel::getChannelList(["id"=>"channel","type"=>"son","typeid"=>"44","orderby"=>"weigh","orderway"=>"asc"]); if(is_array($__pkXKO7vjih__) || $__pkXKO7vjih__ instanceof \think\Collection || $__pkXKO7vjih__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__pkXKO7vjih__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;$__71lVZ4nzsL__ = \addons\cms\model\Archives::getArchivesList(["id"=>"prod","channel"=>$channel['id'],"orderby"=>"weigh","orderway"=>"desc","row"=>"20"]); if(is_array($__71lVZ4nzsL__) || $__71lVZ4nzsL__ instanceof \think\Collection || $__71lVZ4nzsL__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__71lVZ4nzsL__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$prod): $mod = ($i % 2 );++$i;?>
        <li class="feature_item swiper-slide"> 
          ...
          <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__71lVZ4nzsL__; endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__pkXKO7vjih__; ?>
        </ul> 
     ...
     <section class="layout"> 
      ...
      <div class="company_info_wrap"> 
       <div class="company_img wow fadeInLeftA" data-wow-delay="1s" data-wow-duration="1s">
        <?php $__hRiPzr13DT__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"about","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__hRiPzr13DT__) || $__hRiPzr13DT__ instanceof \think\Collection || $__hRiPzr13DT__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__hRiPzr13DT__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
          <img src="<?php echo $block['image']; ?>" alt="About Us">
        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__hRiPzr13DT__; ?>
       </div> 
       <div class="company_information wow fadeInRightA" data-wow-delay="1s" data-wow-duration="1s" style="height: 500px; overflow: hidden;"> 
        ...
        <?php $__khnZwQW3xc__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"about","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__khnZwQW3xc__) || $__khnZwQW3xc__ instanceof \think\Collection || $__khnZwQW3xc__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__khnZwQW3xc__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
        <div class="about_text">
            <?php echo $block['content']; ?> 
        </div> 
        <a href="<?php echo $block['url']; ?>" class="about_btn">more&gt;&gt;</a> 
        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__khnZwQW3xc__; ?>
       </div> 
      </div> 
     </section> 
    </section> 
    ...
    <section class="index_advantage_container"> 
     <section class="layout"> 
      <ul class="advantage_items"> 
        <?php $__l2mhgZGUvo__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"about-info","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__l2mhgZGUvo__) || $__l2mhgZGUvo__ instanceof \think\Collection || $__l2mhgZGUvo__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__l2mhgZGUvo__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;if(!(empty($block['images']) || (($block['images'] instanceof \think\Collection || $block['images'] instanceof \think\Paginator ) && $block['images']->isEmpty()))): if(is_array(explode(',',$block['images'])) || explode(',',$block['images']) instanceof \think\Collection || explode(',',$block['images']) instanceof \think\Paginator): $i = 0; $__LIST__ = explode(',',$block['images']);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$image): $mod = ($i % 2 );++$i;?>
          ...
          <?php endforeach; endif; else: echo "" ;endif; endif; endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__l2mhgZGUvo__; ?>
      </ul> 
     </section> 
    ...
    <section class="index_application_container"> 
     <section class="layout"> 
      ...
      <ul class="application_items"> 
        <?php $__P6pBlRmuG9__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"hlight","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__P6pBlRmuG9__) || $__P6pBlRmuG9__ instanceof \think\Collection || $__P6pBlRmuG9__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__P6pBlRmuG9__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;if(!(empty($block['images']) || (($block['images'] instanceof \think\Collection || $block['images'] instanceof \think\Paginator ) && $block['images']->isEmpty()))): if(is_array(explode(',',$block['images'])) || explode(',',$block['images']) instanceof \think\Collection || explode(',',$block['images']) instanceof \think\Paginator): $i = 0; $__LIST__ = explode(',',$block['images']);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$image): $mod = ($i % 2 );++$i;?>
        ...
        <?php endforeach; endif; else: echo "" ;endif; endif; endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__P6pBlRmuG9__; ?>
      </ul> 
     </section> 
    </section> 
    ...
    <section class="icon_list_contianer layout" style="background-image: url(/template/default/images/icons_bg.jpg)"> 
     <ul class="icon_items"> 
      <?php $__uQFvaLrjCg__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"abount-params","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__uQFvaLrjCg__) || $__uQFvaLrjCg__ instanceof \think\Collection || $__uQFvaLrjCg__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__uQFvaLrjCg__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;if(!(empty($block['images']) || (($block['images'] instanceof \think\Collection || $block['images'] instanceof \think\Paginator ) && $block['images']->isEmpty()))): if(is_array(explode(',',$block['images'])) || explode(',',$block['images']) instanceof \think\Collection || explode(',',$block['images']) instanceof \think\Paginator): $i = 0; $__LIST__ = explode(',',$block['images']);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$image): $mod = ($i % 2 );++$i;?>
        ...
        <?php endforeach; endif; else: echo "" ;endif; endif; endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__uQFvaLrjCg__; ?>
     </ul> 
    </section> 
    ...
    <section class="index_news_container"> 
     <section class="layout"> 
      ...
      <div class="news_container"> 
        <?php $__LeJbuFyQSZ__ = \addons\cms\model\Archives::getArchivesList(["id"=>"new","channel"=>"67","orderby"=>"weigh","orderway"=>"desc","row"=>"1","addon"=>"content"]); if(is_array($__LeJbuFyQSZ__) || $__LeJbuFyQSZ__ instanceof \think\Collection || $__LeJbuFyQSZ__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__LeJbuFyQSZ__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?>
       ...
       <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__LeJbuFyQSZ__; ?>
       <div class="news_left wow fadeInLeftA" data-wow-delay=".8s" data-wow-duration="1s"> 
        <?php $__EUY9Jh1Ppu__ = \addons\cms\model\Archives::getArchivesList(["id"=>"new","channel"=>"68","orderby"=>"weigh","orderway"=>"desc","row"=>"2","addon"=>"content"]); if(is_array($__EUY9Jh1Ppu__) || $__EUY9Jh1Ppu__ instanceof \think\Collection || $__EUY9Jh1Ppu__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__EUY9Jh1Ppu__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?>
        <div class="news_item"> 
          <figure> 
           <time class="news_time"><span><?php echo date("d",$new['publishtime']); ?></span><span><?php echo date("Y-m",$new['publishtime']); ?></span></time> 
           <h4 class="news_title"><a href=<?php echo $new['url']; ?>><?php echo $new['title']; ?></a></h4> 
         ...
         <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__EUY9Jh1Ppu__; ?>
       </div> 
      </div> 
     </section> 
    </section> 
   ...
   <footer class="web_footer"> 
    <ul class="foot_nav wow fadeInUpA" data-wow-delay="1s" data-wow-duration=".8s"> 
     <?php $__IeL7Db16kc__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","type"=>"top","cache"=>"0","condition"=>"1=isnav","row"=>"20","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__IeL7Db16kc__) || $__IeL7Db16kc__ instanceof \think\Collection || $__IeL7Db16kc__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__IeL7Db16kc__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
        <li><a href="<?php echo $nav['url']; ?>"><?php echo $nav['name']; ?></a> </li>
     <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__IeL7Db16kc__; ?>
    </ul> 
    <div class="foot_bottom layout"> 
     ...
     <ul class="foot_sns wow fadeInUpA" data-wow-delay="1.5s" data-wow-duration=".8s"> 
        <?php $__LsTrcUPjXu__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"media","orderby"=>"weigh","orderway"=>"asc"]); if(is_array($__LsTrcUPjXu__) || $__LsTrcUPjXu__ instanceof \think\Collection || $__LsTrcUPjXu__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__LsTrcUPjXu__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
            <li><a href="<?php echo $block['url']; ?>"><img src="<?php echo $block['image']; ?>" alt="<?php echo $block['title']; ?>"></a></li> 
        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__LsTrcUPjXu__; ?>
     </ul> 
  ...
  <aside class="scrollsidebar" id="scrollsidebar"> 
   <section class="side_content"> 
    <div class="side_list"> 
     ...
     <div class="t-code">
    <?php $__aIFiWhsZD3__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"online-service","orderby"=>"weigh","orderway"=>"asc"]); if(is_array($__aIFiWhsZD3__) || $__aIFiWhsZD3__ instanceof \think\Collection || $__aIFiWhsZD3__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__aIFiWhsZD3__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
      <img src="<?php echo $block['image']; ?>">
    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__aIFiWhsZD3__; ?>
