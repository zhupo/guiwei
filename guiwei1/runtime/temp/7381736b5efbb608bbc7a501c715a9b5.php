<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"/Users/panliu/Documents/privateProject/guiwei/guiwei1/addons/cms/view/default1/index.html";i:1688559438;s:94:"/Users/panliu/Documents/privateProject/guiwei/guiwei1/addons/cms/view/default1/common/top.html";i:1688562888;s:95:"/Users/panliu/Documents/privateProject/guiwei/guiwei1/addons/cms/view/default1/common/foot.html";i:1688480862;}*/ ?>
<!doctype html>
<html>
 <head> 
 ...
 <body> 
  <div class="container"> 
   ...
   <header class="web_head index_web_head"> 
    ...
    <div class="head_layout layout"> 
     ...
     <nav class="nav_wrap"> 
      <ul class="head_nav"> 
       <?php $__GPlIt54mXq__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","type"=>"top","cache"=>"0","condition"=>"1=isnav","row"=>"20","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__GPlIt54mXq__) || $__GPlIt54mXq__ instanceof \think\Collection || $__GPlIt54mXq__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__GPlIt54mXq__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
        <li>
            <a href="<?php echo $nav['url']; ?>"><?php echo $nav['name']; ?></a>
            <?php if($nav['has_child']): ?>
                <ul>
                    <?php $__KzI8cZdlOi__ = \addons\cms\model\Channel::getChannelList(["id"=>"son","type"=>"son","condition"=>"1=isnav","typeid"=>$nav['id'],"cache"=>"0","row"=>"20"]); if(is_array($__KzI8cZdlOi__) || $__KzI8cZdlOi__ instanceof \think\Collection || $__KzI8cZdlOi__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__KzI8cZdlOi__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$son): $mod = ($i % 2 );++$i;?>
                        <li><a href="<?php echo $son['url']; ?>"><?php echo $son['name']; ?></a>
                        <?php if($son['has_child']): ?>
                            <ul>
                            <?php $__GMSIXAFwtJ__ = \addons\cms\model\Channel::getChannelList(["id"=>"sons","condition"=>"1=isnav","type"=>"son","typeid"=>$son['id'],"cache"=>"0"]); if(is_array($__GMSIXAFwtJ__) || $__GMSIXAFwtJ__ instanceof \think\Collection || $__GMSIXAFwtJ__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__GMSIXAFwtJ__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sons): $mod = ($i % 2 );++$i;?>
                                <li><a href="<?php echo $sons['url']; ?>"><?php echo $sons['name']; ?></a></li>
                            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__GMSIXAFwtJ__; ?>
                            </ul> 
                        <?php endif; ?>
                        </li>
                    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__KzI8cZdlOi__; ?>
                </ul>
            <?php endif; ?>
        </li>
        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__GPlIt54mXq__; ?>
      </ul> 
      <!--change-language--> 
  ...
  <ul class="prisna-wp-translate-seo" id="prisna-translator-seo"> 
   ...
   <section class="slider_banner swiper-container"> 
    ...
    <?php $__JZnd6Sr5UO__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"banner","orderby"=>"weigh","orderway"=>"desc"]); if(is_array($__JZnd6Sr5UO__) || $__JZnd6Sr5UO__ instanceof \think\Collection || $__JZnd6Sr5UO__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__JZnd6Sr5UO__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>   
      <div class="swiper-slide">
        <a href="<?php echo $block['url']; ?>"><img src="<?php echo $block['image']; ?>" alt=""></a>
      </div> 
    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__JZnd6Sr5UO__; ?>
    </div> 
     ...
     <section class="layout"> 
      ...
      <section class="feature_item_wrap wow fadeInUpA" data-wow-delay="1.3s" data-wow-duration=".8s"> 
       <div class="feature_items"> 
        ...
        <?php $__KxJROGv9Ei__ = \addons\cms\model\Channel::getChannelList(["id"=>"channel","type"=>"son","typeid"=>"44","orderby"=>"weigh","orderway"=>"asc"]); if(is_array($__KxJROGv9Ei__) || $__KxJROGv9Ei__ instanceof \think\Collection || $__KxJROGv9Ei__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__KxJROGv9Ei__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;$__J8kIqQv06a__ = \addons\cms\model\Archives::getArchivesList(["id"=>"prod","channel"=>$channel['id'],"orderby"=>"weigh","orderway"=>"desc","row"=>"20"]); if(is_array($__J8kIqQv06a__) || $__J8kIqQv06a__ instanceof \think\Collection || $__J8kIqQv06a__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__J8kIqQv06a__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$prod): $mod = ($i % 2 );++$i;?>
        <li class="feature_item swiper-slide"> 
          ...
          <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__J8kIqQv06a__; endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__KxJROGv9Ei__; ?>
         <!-- <li class="feature_item swiper-slide"> 
          <figure> 
